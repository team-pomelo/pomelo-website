...
develop: lib/python*/site-packages/pomelowebsite.egg-link
lib/python*/site-packages/pomelowebsite.egg-link:
	$(PY) setup.py develop
...
coverage: $(NOSE)
	...
	@$(NOSE) --nologcapture --with-coverage --cover-package=pomelowebsite
